define({ "api": [
  {
    ...
    "name": "getAggrBills",
    "group": "Aggregate",
    "description": "<p>Возвращает список транзакционных агрегатов</p>",
    "header": {
      "fields": {
        "Authorization": [
          {
        ...
        "Parameter": [
          {
            ...
            "optional": true,
            "field": "fromDate",
            "description": "<p>Нижняя граница фильтра по дате, по умолчанию - Unix Epoch.</p>"
          },
          {
            "group": "Parameter",
            "type": "Date",
            "optional": true,
            "field": "toDate",
            "description": "<p>Верхняя граница фильтра по дате, по умолчанию - текущая дата.</p>"
          }
        ]
      }
    },
        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "result",
            "description": "<p>Массив транзакционных агрегатов.</p>"
          }
        ]
      }
    },
