 ...
 */
     ...
     * граничное значение.(Для начала - 01.01.1970T00:00:00.000Z, для конца - текущая дата и время)
     * Формат даты - YYYY-MM-DDThh:mm:ss.sssX X - спецификация часового пояса
     *
     * @apiHeader (Authorization) authorization Authorization value.
     * @apiHeaderExample Headers-Example:
     *   { "Authorization": "Bearer :jwtToken" }
