...
router
     ...
     *   { "Authorization": "Bearer :jwtToken" }
     *   
     * @apiParam {Date} fromDate нижняя граница даты (ISO) отбора платёжных данных
     * @apiParam {Date} toDate верхняя грань даты (ISO) отбора платёжных данных
     * 
     * @apiParamExample Params-Example:
     * /api/aggrBills/items?fromDate=2018-05-01T00:00:00Z&toDate=2018-06-01T00:00:00Z
     * 
